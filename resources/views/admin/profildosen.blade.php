...
<form action="{{ url('/editdosenput/'.$dosen->kode_dosen.'/'.$dosen->username) }}" method="post" enctype="multipart/form-data">
<div class="row">
    <div class="col-4">
    ...
    <div class="col-8">
        <div class="form-group row">
            <label class="">Kode dosen:</label><p style="color:red"> *Sangat berbahaya untuk edit kode dosen</p>
            <input type="text" class="form-control" name="kodedosen" value="{{ $dosen->kode_dosen }}" required maxlength="16" readonly>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <input type="textarea" class="form-control" name="password" value="{{ $dosen->password }}" maxlength="16">
        </div>
    </div>
