...
<nav class="navbar navbar-dark bg-primary">
  ...
  Anda login sebagai 
  <a href="{{ url('/mahasiswa/profilmahasiswa/') }}" class="text-white">{{Session::get('name')}}</a>
...
<div class="row" id="body-row">
    ...
    <div id="sidebar-container" class="sidebar-expanded d-none d-md-block">
        ...
        <a href="#" data-toggle="sidebar-colapse" class="bg-dark list-group-item list-group-item-action d-flex align-items-center">
            ...
            <!-- /END Separator -->
            <a href="{{url('/mahasiswa')}}" class="bg-dark list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
                    <span class="fa fa-chalkboard-teacher fa-fw mr-3"></span>
                    <span class="menu-collapsed">Kelas</span>
                </div>
            </a>
            <a href="{{url('/mahasiswa/listtugas')}}" class="bg-dark list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
            ...
            <!-- /END Separator -->
            <a href="{{ url('/mahasiswa/profilmahasiswa/') }}" class="bg-dark list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
